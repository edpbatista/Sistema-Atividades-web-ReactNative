...
const ListarAtividades = () => {
    ...
    return (
        <div className="container">
                            ...
                            <td>
                                {editingId === atividade.id ? (
                                    <React.Fragment>
                                        ...
                                        <button className="button" onClick={() => handleCancelarEdicao()}>
                                            Cancelar
                                        </button>
                                    </React.Fragment>
                                ) : (
                                    <React.Fragment>
                                        ...
                                        <button className="button" onClick={() => handleDelete(atividade.id)}>
                                            Deletar
                                        </button>
                                    </React.Fragment>
            ...
            <button type="button" className="button" onClick={handleVoltar}>
                Voltar
            </button>
        </div>
    );
